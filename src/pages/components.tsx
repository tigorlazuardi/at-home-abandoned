		...
		<Layout>
			...
			<main>
				<section className={clsx(mode === 'dark' ? 'bg-dark' : 'bg-gray-50', color)}>
					<div className={clsx('min-h-screen py-20 layout', mode === 'dark' ? 'text-white' : 'text-black')}>
						...
						<ol className='mt-8 space-y-6'>
							...
							<li className='space-y-2'>
								...
								<div className='space-x-2'>
									...
									<CustomLink href='https://theodorusclarence.com'>Outside Links</CustomLink>
								</div>
							</li>
							<li className='space-y-2'>
								<h2 className='text-lg md:text-xl'>ButtonLink</h2>
								<p className={clsx('text-sm !mt-1', textColor)}>Button styled link with 3 variants.</p>
								<div className='flex flex-wrap gap-2'>
							...
							<li className='space-y-2'>
								...
								<p className={clsx('text-sm !mt-1', textColor)}>Ordinary button with style.</p>
								<div className='flex flex-wrap gap-2'>
									...
									<Button onClick={() => alert('button clicked')} variant='light'>
										Light Variant
									</Button>
								</div>
								<div className='flex flex-wrap gap-2'>
									<Button disabled onClick={() => alert('button clicked')} variant='primary'>
										Disabled
									</Button>
									<Button disabled variant='dark' onClick={() => alert('button clicked')}>
										Disabled
									</Button>
									<Button disabled onClick={() => alert('button clicked')} variant='light'>
										Disabled
									</Button>
								</div>
								<div className='flex flex-wrap gap-2'>
									<Button isLoading onClick={() => alert('button clicked')} variant='primary'>
										Disabled
									</Button>
									<Button isLoading variant='dark' onClick={() => alert('button clicked')}>
										Disabled
									</Button>
									<Button isLoading onClick={() => alert('button clicked')} variant='light'>
										Disabled
									</Button>
								</div>
							</li>
							<li className='space-y-2'>
								...
								<p className={clsx('text-sm !mt-1', textColor)}>Styled 404 page with some animation.</p>
								<div className='flex flex-wrap gap-2'>
